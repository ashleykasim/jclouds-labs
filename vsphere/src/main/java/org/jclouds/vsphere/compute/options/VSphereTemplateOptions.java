...
public class VSphereTemplateOptions extends TemplateOptions implements Cloneable {
   ...
   public void copyTo(TemplateOptions to) {
      ...
      if (to instanceof VSphereTemplateOptions) {
         ...
         if (staticIp() != null)
            eTo.staticIp(staticIp());
         if (subnetMask() != null)
            eTo.subnetMask(subnetMask());
         if (dnsDomain() != null)
            eTo.dnsDomain(dnsDomain());
         if (dnsDomain() != null)
            eTo.dnsDomain(dnsDomain());
         if (gateway() != null)
            eTo.gateway(gateway());
         if (dnsServerList() != null)
            eTo.dnsServerList(dnsServerList());
         if (waitOnPort() != null)
            eTo.waitOnPort(waitOnPort());
         if (secondaryDisk() != null)
            eTo.secondaryDisk(secondaryDisk());
         if (vmFolder() != null)
   ...
   private String[] dnsServerList = null;
   private Long secondaryDisk = null;
   ...
   public Long secondaryDisk() {
      return secondaryDisk;
   }

   public VSphereTemplateOptions secondaryDisk(Long secondaryDisk) {
   ...
   public VSphereTemplateOptions staticIp(String staticIp) {
      this.staticIp = staticIp;
      return this;
   }
   public VSphereTemplateOptions dnsDomain(String dnsDomain) {
      this.dnsDomain = dnsDomain;
      return this;
   }
   public VSphereTemplateOptions subnetMask(String subnetMask) {
      this.subnetMask = subnetMask;
      return this;
   }
   public VSphereTemplateOptions gateway(String[] gateway) {
      this.gateway = gateway;
      return this;
   }
   public VSphereTemplateOptions dnsServerList(String[] dnsServerList) {
   ...
   public static class Builder {
      ...
      /**
       * @see VSphereTemplateOptions#staticIp(String staticIp)
       */
      public static VSphereTemplateOptions staticIp(String staticIp) {
         return new VSphereTemplateOptions().staticIp(staticIp);
      }

      /**
       * @see VSphereTemplateOptions#subnetMask(String subnetMask)
       */
      public static VSphereTemplateOptions subnetMask(String subnetMask) {
         return new VSphereTemplateOptions().subnetMask(subnetMask);
      }

      /**
       * @see VSphereTemplateOptions#dnsDomain(String dnsDomain)
       */
      public static VSphereTemplateOptions dnsDomain(String dnsDomain) {
         return new VSphereTemplateOptions().dnsDomain(dnsDomain);
      }

      /**
       * @see VSphereTemplateOptions#dnsServerList(String[] dnsServerList)
       */
      public static VSphereTemplateOptions dnsServerList(String[] dnsServerList) {
         return new VSphereTemplateOptions().dnsServerList(dnsServerList);
      }

      /**
       * @see VSphereTemplateOptions#gateway(String[] gateway)
       */
      public static VSphereTemplateOptions gateway(String[] gateway) {
         return new VSphereTemplateOptions().gateway(gateway);
      }
